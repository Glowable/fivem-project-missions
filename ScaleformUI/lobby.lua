...
RegisterCommand('ScaleformUILua_SetHeaderMenu', function(source, args) -- Use command before menu open.
    ...
    CreateRuntimeTextureFromDuiHandle(CreateRuntimeTxd('ScaleformUI_Lua_duiTxd'), "stunt-45", GetDuiHandle(CreateDui("https://cdn.discordapp.com/attachments/1063889807085940847/1084563602909970482/image.png", 320, 180)))
...
RegisterCommand('ScaleformUILua_SetInfo', function(source, args) -- Use command before menu open.
    local infoList = {
        {
            LeftLabel = "Map",
            RightLabel = "Around the World°",
            BadgeStyle = 179,
            Colours = false,
        },
        {
            LeftLabel = "Made by:",
            RightLabel = "gingerTravis",
            BadgeStyle = 179,
            Colours = false,
        },
        {
